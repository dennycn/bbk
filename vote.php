...
<div class="RoundedCorner"> <b class="rtop"><b class="r1"></b><b class="r2"></b><b class="r3"></b><b class="r4"></b></b>
    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="65" valign="middle" bgcolor="#eeeeee"><span class="blueklinkFont">&nbsp;&nbsp;<a href="index.php" target=_parent>&laquo;返回比比看主页</a></span></td>
      </tr>
      <tr>
        <td height="35"><?php
$pid = "";
...
<td height="30"><span class="darkFont"><img src="images/bar3_l.gif" width="3" height="15" align="absmiddle" alt="图柱"><img src="images/bar3.gif" width="<?php print $firstlen; ?>" height="31" align="absmiddle" alt="图柱"><img src="images/bar3_r.gif" width="3" height="15" align="absmiddle" alt="图柱">&nbsp;<?php print $firstvalue;?>&nbsp;</span></td>
</tr>
<tr bgcolor="F6F6F6">
<td width="30%" height="30" align="center" class="darkFont">
<b><?php print $secname; ?></b>搜索好</td>
<td height="30">
<span class="darkFont"><img src="images/bar2_l.gif" width="3" height="15" align="absmiddle" alt="图柱"><img src="images/bar2.gif" width="<?php print $seclen; ?>" height="31" align="absmiddle" alt="图柱"><img src="images/bar2_r.gif" width="3" height="15" align="absmiddle" alt="柱图">&nbsp;<?php print $secvalue;?>&nbsp;</span></td>
</tr>
</table>
